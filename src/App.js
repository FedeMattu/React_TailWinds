...
function App() {
  ...
  return (
    <div>
      ...
      <nav id="header" className="fixed px-5 w-full z-30 top-0 bg-gradient-to-r from-purple-800 to-indigo-500 text-white">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
          ...
          <div
            ...
            <ul className="list-reset lg:flex justify-end flex-1 items-center">
              <li className="mr-3">
                <a className="inline-block py-2 px-4 text-black font-bold no-underline"><Link to="/">Home</Link></a>
              </li>
              <li className="mr-3">
                <a className="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                  href="profile.html"><Link to="/login">Login</Link></a>
              </li>
              <li className="mr-3">
                <a className="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
                  href="login.html"><Link to="/contact">Contact Me</Link></a>
              </li>
            </ul>
            <button id="navAction"
              claclassNamess="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Action
            </button>
          </div>
        </div>
